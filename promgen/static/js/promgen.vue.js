...
const app = Vue.createApp({
    ...
    methods: {
        ...
        getActiveSilencesForService: function (serivce) {
            return getActiveSilences(this.activeSilences, 'service', serivce);
        },
        getActiveSilencesForProject: function (project, service) {
            ...
            return silencesMatchProject.filter(silence => silencesMatchService.includes(silence));
        },
    },
    computed: {
